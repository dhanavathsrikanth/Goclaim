    ...
    <div className="flex-1 w-full pt-12 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="space-y-8 text-foreground/80 text-sm leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-foreground mb-3">5. Free coupon codes</h2>
            <ul className="space-y-2 list-disc list-inside">
              <li>Promotional codes (e.g. EARLY100) cover a $2 starter listing at no charge.</li>
